...
const CategorySchema = z.object({
    ...
    image: FileSchema,
    subCategoryIds: z.array(z.string()).nonempty('Las subcategorías son obligatorias'),
    brandIds: z.array(z.string()).nonempty('Las marcas son obligatorias'),
    promotionIds: z.array(z.string()).nonempty('Las promociones son obligatorias'),
...
const DeleteCategorySchema = z.object({
    ...
    catalogPaths: z.array(z.string()).min(1, 'Las rutas de los catálogos son obligatorias').trim().optional(),
})
